...
-   [ ] 숫자 버튼 그리드 구현
-   [ ] 연산자 버튼 구현
-   [ ] 기본 공학 함수 버튼 행 구현 (sin, cos, tan, π)
-   [ ] 추가 공학 함수 버튼 행 구현 (ln, log, e, rad/deg)
-   [ ] 유틸리티 버튼 행 구현 ((, ), hist, help)
-   [ ] 버튼 액션 연결
...
-   [ ] 버튼 길게 누르기 제스처 구현
-   [ ] 컨텍스트 메뉴로 확장 함수 접근
-   [ ] 역삼각함수 (asin, acos, atan) 접근
-   [ ] 추가 수학 함수 (x², √x, xʸ, !, 1/x) 접근
-   [ ] 지수 함수 (eˣ, 10ˣ, log₂) 접근
...
-   [ ] 다양한 iPhone 크기 대응 (13 mini ~ 14 Pro Max)
-   [ ] Safe Area 처리
-   [ ] 세로 모드 최적화된 버튼 크기 및 간격 조정
-   [ ] 화면 방향 고정 (Portrait Only) 설정 확인
